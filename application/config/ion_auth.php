 ...
 */
 $CI =  & get_instance();
 $CI->load->config('dn');
$config['site_title']                 = $CI->config->item('site_settings')->site_title;       // Site Title, example.com
$config['admin_email']                = $CI->config->item('site_settings')->portal_email; // Admin Email, admin@example.com
