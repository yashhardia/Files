<div class="col-md-10 col-sm-10 paddig">
   <div class="brade">
      ...
      &gt; <a href="<?php echo base_url().URL_SMS_TEMPLATES;?>"><?php if(isset($this->phrases['sms templates'])) echo $this->phrases['sms templates'];?></a>  &gt; 	  
      ...
      <div id="infoMessage"><?php if(isset($message)) echo $message;?></div>
         ...
         <div class="panel-body paddig">
            <div class="inner-pages-forms">
               <div class="col-md-6">
                  <?php 
                     $attributes = array('name' => 'sms_template_form', 'id' => 'sms_template_form');
                     echo form_open_multipart(URL_SMS_TEMPLATES.DS.$opt,$attributes);?> 
                  ...
                  <div class="form-group">    
                     <label><?php if(isset($this->phrases['sms template'])) echo $this->phrases['sms template'];?> <span style="color:red;">*</span> </label>  
                     <textarea class="ckeditor" id="editor1" name="sms_template" cols="1000" rows="1000"><?php if(isset($template_info->sms_template))
                        echo $template_info->sms_template;?></textarea>
                  ...
                  <input type="hidden" name="id" value="<?php if(isset($template_info->sms_template_id)) 
                     echo $template_info->sms_template_id;?>"/>
     ...
     JQUERY4U.UTIL = {
         setupFormValidation: function() {
          ...
          $("#sms_template_form").validate({
            ...
            messages: {
				sms_template: {
					required: "<?php if(isset($this->phrases['sms template'])) echo $this->phrases['sms template'].' '.$this->phrases['required'];?>"
				}
           },
