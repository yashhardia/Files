   ...
   <div class="admin-body">
      <div class="inner-elements">
         <div class="col-md-12">
            ...
            <td><?php echo $val['restaurant_id'];?></td>
            <td><?php echo $val['description'];?></td>
            <td><script>rate(<?php echo $val['rating']?>);</script></td>
            </tr><?php }?>
           </table> 
