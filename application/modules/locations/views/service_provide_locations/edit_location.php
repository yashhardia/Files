            ...
            <div class="panel">
               ...
               <div class="panel-body paddig">
				  ...
				  $attributes = array('name'=>'add_service_location_form','id'=>'add_service_location_form');
                     echo form_open(URL_EDIT_SERVICE_LOCATIONS,$attributes); ?>
                  ...
                  <div class="form-group">                    
                     ...
                     <?php 
                        ...
                        echo form_dropdown('city_id',$city_options,$record->city_id,$js);
				...
				<div class="form-group">                    
                  ...
                  <div class="form-group">
                     ...
                     <input type="hidden" name="update_rec_id" value="<?php  echo $record->service_provide_location_id;?>"/>
                     <div class="buttos">
