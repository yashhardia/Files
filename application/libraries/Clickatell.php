...
class Clickatell
{
    ...
    public function __construct()
    {
		...
		//echo "IN Lib";
		$query = 'SELECT sf.* FROM `dn_system_settings_fields` sf INNER JOIN `dn_sms_gate_ways` sst ON sf.sms_gateway_id = sst.sms_gateway_id WHERE sst.sms_gateway_name = "Cliakatell" ORDER BY field_name';		
